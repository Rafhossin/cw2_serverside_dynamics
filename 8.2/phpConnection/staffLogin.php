...
if ($doctor_email_result) {
    // Return true with role "doctor" if email found in doctor records
    ...
    if ($receptionist_email_result) {
        // Return true with role "receptionist" if email found in receptionist records
        echo json_encode(array("success" => true, "role" => "receptionist"));
    } else {
        // Return false if email not found in either doctor or receptionist records
